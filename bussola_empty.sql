...
--
-- Host: localhost    Database: bussola
-- ------------------------------------------------------
-- Server version	5.1.49-1ubuntu8-log
...
CREATE TABLE `arquivos` (
  ...
  `pasta` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `area` int(11) DEFAULT NULL,
  `lastlogin` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (1,'Administrador','admin','80177534a0c99a7e3645b52f2027a48b',0,'',1,1);
##adm123
...
-- Dump completed on 2010-10-23 12:36:27
